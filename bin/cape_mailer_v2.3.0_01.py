...
def submit_to_cape(cfg: dict, sample_path: str) -> Optional[int]:
    ...
    try:
        ...
        logger.error("❌ CAPE Submit Timeout (>60s)")
        return None
    except FileNotFoundError:
        logger.error("❌ /opt/CAPEv2/utils/submit.py nicht gefunden!")
        return None
    except Exception as e:
...
<div class="container">
    ...
    <hr>
    <p style="color:#666; font-size:12px;">CAPE Mailer v2.3.0</p>
</div>
</body>
</html>"""
...
def main():
    """Hauptfunktion"""
    logger.info("=" * 60)
    logger.info("CAPE Mailer v2.3.0 - Multi-Source Auth + Routing-Analyse gestartet")
        ...
        for mail_data in mails:
            ...
            try:
                ...
                if success:
                    ...
                    logger.info(f"✅ Mail #{uid} als gelesen markiert")
                else:
