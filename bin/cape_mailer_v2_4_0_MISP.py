...
def create_misp_phishing_event(cfg: dict, result, subject: str) -> bool:
    ...
    try:
        ...
        if export_cfg['domains']:
            for url_analysis in result.url_analyses:
                if url_analysis.is_typosquatting and url_analysis.domain:
                    event.add_attribute('domain', url_analysis.domain,
                                      to_ids=attribute_to_ids,
                                      comment='Typosquatting detected')
...
<div class="container">
    ...
    <p style="color:#666; font-size:12px;">
        Generiert von CAPE Phishing Analyzer v2.3.0 (OSINT Integration) (Multi-Source Auth + Routing-Analyse)<br>
...
<div class="container">
    ...
    <hr>
    <p style="color:#666; font-size:12px;">CAPE Mailer v2.4.0</p>
</div>
</body>
</html>"""
...
def main():
    """Hauptfunktion"""
    logger.info("=" * 60)
    logger.info("CAPE Mailer v2.4.0 - Multi-Source Auth + Routing-Analyse gestartet")
