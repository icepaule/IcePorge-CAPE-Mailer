...
<div class="container">
    ...
    <hr>
    <p style="color:#666; font-size:12px;">CAPE Mailer v2.4.1</p>
</div>
</body>
</html>"""
...
def acquire_process_lock():
    ...
    """
    lock_file_path = '/var/run/cape-mailer.lock'
    ...
    try:
        ...
        # Lock bereits gehalten von anderem Prozess
        return None
...
def main():
    """Hauptfunktion"""
    logger.info("=" * 60)
    logger.info("CAPE Mailer v2.4.1 - Multi-Source Auth + Routing-Analyse gestartet")
